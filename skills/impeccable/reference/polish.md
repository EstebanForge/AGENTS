...
4. **Prior critique lookup is NOT vendored** (`critique-storage.mjs` was stripped). If the user has run `/impeccable critique` before on the same target, ask them to paste the P0/P1 items; otherwise continue without a prior. Do your own pass either way.
