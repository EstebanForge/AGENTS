...
description: Validate and repair Mermaid diagrams using mermaid-cli. Use when Mermaid diagram syntax is broken, failing to render, or undergoing syntax verification.
---
